    ...
    public ProductosView() {
        ...
        grid.addColumn(
                new ComponentRenderer<>(producto -> {
                    ...
                    botonEditar.setIcon(new Icon(VaadinIcon.MINUS));

                    HorizontalLayout buttons = new HorizontalLayout(botonBorrar, botonAgregar, botonEliminar,botonEditar);
                    return buttons;
                })).setHeader("administrar").setAutoWidth(true);
